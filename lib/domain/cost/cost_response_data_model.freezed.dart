...
class _$CostResponseDataModelTearOff {
  ...
  _CostResponseDataModel call(
      ...
      @JsonKey(name: "results") List<CourierDataModel> results = const []}) {
...
mixin _$CostResponseDataModel {
  ...
  List<CourierDataModel> get results => throw _privateConstructorUsedError;
...
abstract class $CostResponseDataModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "origin_details") CityDataModel? originDetails,
      @JsonKey(name: "destination_details") CityDataModel? destinationDetails,
      @JsonKey(name: "results") List<CourierDataModel> results});
...
class _$_CostResponseDataModel implements _CostResponseDataModel {
  ...
  @override
  @JsonKey(name: "results")
  final List<CourierDataModel> results;

  @override
  String toString() {
    return 'CostResponseDataModel(status: $status, originDetails: $originDetails, destinationDetails: $destinationDetails, results: $results)';
  }
...
abstract class _CostResponseDataModel implements CostResponseDataModel {
  factory _CostResponseDataModel(
      ...
      @JsonKey(name: "results")
          List<CourierDataModel> results}) = _$_CostResponseDataModel;
